          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="text-sm font-medium text-blue-300">Salons & Beauty</span>
              </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color === "rose" ? "from-blue-100 to-blue-50" : "from-blue-100 to-blue-50"} mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <feature.icon
                      className={`w-7 h-7 ${feature.color === "rose" ? "text-blue-600" : "text-blue-600"}`}
                    />
                  </div>
